#!/usr/bin/env python3
"""Generate a SQL Server report with the shared professional Word engine."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a professional SQL Server inspection DOCX.")
    ...
    parser.add_argument("--company", default=SQLSERVER_WORD_PROFILE.default_company)
